...
public class TransactionDetails extends HttpServlet {
	...
	public void init() throws ServletException {
		System.out.println("inside the TransactionDetails servlet");
		try {
	...
	protected void doPost(HttpServletRequest request,
		...
		System.out.println("Reached Transaction details Servlet");
...
//		if(session!=null)
      ...
      String Items = "";
		...
		String query = "select transId,memerId,BOB from bmps_transhistory where memerId = '"+memberId2+"'";
	...
	ResultSet rs = pstmt.executeQuery();
			      ...
			      while (rs.next ()){
			        ...
			        //Add records into data list
			    	  ...
			    	  rows.add(rs.getString("transId"));
			        rows.add(rs.getString("memerId"));
			        rows.add(rs.getString("BOB"));
