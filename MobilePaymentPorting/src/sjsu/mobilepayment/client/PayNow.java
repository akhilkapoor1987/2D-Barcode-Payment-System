...
public class PayNow extends Activity{
	...
	private Bitmap encodeString(String input) throws WriterException{
        ...
        ////////////////////////////////////////////
        ImageView img = (ImageView)findViewById(R.id.paybarcode);
        Button goBack_button = (Button)findViewById(R.id.goBack);
        final String selectedID = extras.getString("contents");
...
//        String abc = guessAppropriateEncoding(selectedID);
       ...
       // 
        	img.setImageBitmap(PayNow.this.encodeString(jadoo.substring(0, jadoo.length()-4)));
