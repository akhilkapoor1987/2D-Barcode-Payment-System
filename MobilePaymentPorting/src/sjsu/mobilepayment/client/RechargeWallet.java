...
public class RechargeWallet extends Activity {
...
////////////setting title bar////////////////
	...
	final	String user = extras1.getString("username");
        ...
        final String userName = extras.getString("memberId");
        ...
        final EditText pinNumber = (EditText)findViewById(R.id.pinNo);
        ...
        cancel_button.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Boolean b = emptyShoppingCart(mCartList);
				Intent newIntent = new Intent(v.getContext(),mainAfterLogin.class);
				newIntent.putExtra("memberId", userName);
        ...
        confirm_button.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
		        ...
		        final String creditCardNumstr = creditCardNum.getText().toString();
		        final String expDatestr = expDate.getText().toString();
		        final String amountstr = amount.getText().toString();
		        final String pinNumbers = pinNumber.getText().toString();
...
//		        Log.w("paymentmethod","paymentmethod = " + paymentmethod);
				...
				nvps.add(new BasicNameValuePair("memberId", userName));
	            ...
	            nvps.add(new BasicNameValuePair("pinNumber",pinNumbers));
				...
				final Dialog dialog = new Dialog(RechargeWallet.this);
...
//				startActivity(newIntent);
	...
	public boolean emptyShoppingCart(List<Device> mCartList)
	{
		mCartList.clear();
		return true;
	}
